...
struct ExposedFormat
{
   ...
   SneedacityAVCodecID codecid;         //!< codec ID (see libavcodec/avcodec.h)
...
struct CompatibilityEntry
{
   ...
   SneedacityAVCodecID codec; //!< codec ID
};
...
private:
   ...
   int FetchCompatibleFormatList(SneedacityAVCodecID id, wxString* selfmt);
   ...
   int FetchCompatibleCodecList(const wxChar* fmt, SneedacityAVCodecID id);
