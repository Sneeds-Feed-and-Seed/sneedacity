...
class SNEEDACITY_DLL_API TimeWarper /* not final */
{
public:
   virtual ~TimeWarper();
...
class SNEEDACITY_DLL_API IdentityTimeWarper final : public TimeWarper
{
public:
   double Warp(double originalTime) const override;
};

class SNEEDACITY_DLL_API ShiftTimeWarper final : public TimeWarper
{
private:
...
class SNEEDACITY_DLL_API LinearTimeWarper final : public TimeWarper
{
private:
   double mScale;
   double mShift;
...
class SNEEDACITY_DLL_API LinearInputRateTimeWarper final : public TimeWarper
{
private:
...
class SNEEDACITY_DLL_API LinearOutputRateTimeWarper final : public TimeWarper
{
private:
...
class SNEEDACITY_DLL_API LinearInputStretchTimeWarper final : public TimeWarper
{
private:
   LinearTimeWarper mTimeWarper;
   double mTStart;
...
class SNEEDACITY_DLL_API LinearOutputStretchTimeWarper final : public TimeWarper
{
private:
   LinearTimeWarper mTimeWarper;
   double mTStart;
...
class SNEEDACITY_DLL_API GeometricInputTimeWarper final : public TimeWarper
{
private:
   LinearTimeWarper mTimeWarper;
   double mTStart;
...
class SNEEDACITY_DLL_API GeometricOutputTimeWarper final : public TimeWarper
{
private:
   LinearTimeWarper mTimeWarper;
   double mTStart;
...
class SNEEDACITY_DLL_API PasteTimeWarper final : public TimeWarper
{
private:
...
class SNEEDACITY_DLL_API RegionTimeWarper final : public TimeWarper
{
private:
   std::unique_ptr<TimeWarper> mWarper;
   double mTStart;
