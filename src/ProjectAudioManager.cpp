...
DefaultPlayOptions( SneedacityProject &project )
{
   auto &projectAudioIO = ProjectAudioIO::Get( project );
...
AudioIOStartStreamOptions
DefaultSpeedPlayOptions( SneedacityProject &project )
{
   auto &projectAudioIO = ProjectAudioIO::Get( project );
   auto gAudioIO = AudioIO::Get();
...
static RegisteredMenuItemEnabler stopIfPaused{{
   ...
   []( SneedacityProject &project, CommandFlag ){
...
GetPropertiesOfSelected(const SneedacityProject &proj)
{
