...
struct FFMPEG_SUPPORT_API AVUtilFunctions
{
   ...
   SneedacityAVDictionaryEntry*
                      (*av_dict_get) (const AVDictionary *m, const char *key, const SneedacityAVDictionaryEntry *prev, int flags) = nullptr;
   ...
   int64_t            (*av_rescale_q) (int64_t a, SneedacityAVRational bq, SneedacityAVRational cq) = nullptr;
