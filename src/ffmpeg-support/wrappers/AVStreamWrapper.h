...
public:
   ...
   virtual SneedacityAVRational GetTimeBase() const noexcept = 0;
   virtual void SetTimeBase(SneedacityAVRational time_base) noexcept = 0;
   ...
   virtual SneedacityAVRational GetSampleAspectRatio() const noexcept = 0;
   virtual void SetSampleAspectRatio(SneedacityAVRational sample_aspect_ratio) noexcept = 0;
