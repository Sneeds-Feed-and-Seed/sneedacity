...
public:
   ...
   virtual SneedacityAVBufferRef* GetBuf() const noexcept = 0;
   ...
   virtual void RescalePresentationTimestamp(SneedacityAVRational bq, SneedacityAVRational cq) noexcept = 0;
   virtual void RescaleDecompressionTimestamp(SneedacityAVRational bq, SneedacityAVRational cq) noexcept = 0;
   virtual void RescaleDuration(SneedacityAVRational bq, SneedacityAVRational cq) noexcept = 0;
