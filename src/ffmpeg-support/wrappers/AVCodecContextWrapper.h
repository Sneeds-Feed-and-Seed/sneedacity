...
public:
   ...
   virtual sampleFormat GetPreferredSneedacitySampleFormat() const noexcept = 0;
   ...
   virtual struct SneedacityAVRational GetTimeBase() const noexcept = 0;
   virtual void SetTimeBase(struct SneedacityAVRational value) noexcept = 0;
