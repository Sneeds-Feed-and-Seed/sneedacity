...
public:
   ...
   SneedacityAVBufferRef* GetBuf() const noexcept override
   {
      if (mAVPacket != nullptr)
         return reinterpret_cast<SneedacityAVBufferRef*>(mAVPacket->buf);
   ...
   void RescalePresentationTimestamp(SneedacityAVRational bq, SneedacityAVRational cq)
   noexcept override
   {
      if (mAVPacket == nullptr)
         return;
   ...
   void RescaleDecompressionTimestamp(SneedacityAVRational bq, SneedacityAVRational cq)
   noexcept override
   {
      if (mAVPacket == nullptr)
         return;
   ...
   void RescaleDuration(SneedacityAVRational bq, SneedacityAVRational cq)
   noexcept override
   {
      if (mAVPacket == nullptr)
         return;
