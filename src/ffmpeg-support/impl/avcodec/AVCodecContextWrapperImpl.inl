...
public:
   ...
   struct SneedacityAVRational GetTimeBase() const noexcept override
   {
      if (mAVCodecContext != nullptr)
      {
   ...
   void SetTimeBase(struct SneedacityAVRational value) noexcept override
   {
      if (mAVCodecContext != nullptr)
      {
   ...
   sampleFormat GetPreferredSneedacitySampleFormat() const noexcept override
   {
      if (mAVCodecContext == nullptr)
         return int16Sample;
