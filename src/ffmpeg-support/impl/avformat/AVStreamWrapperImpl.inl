...
public:
   ...
   SneedacityAVRational GetTimeBase() const noexcept override
   {
      if (mAVStream != nullptr)
   ...
   void SetTimeBase(SneedacityAVRational time_base) noexcept override
   {
      if (mAVStream == nullptr)
         return;
   ...
   SneedacityAVRational GetSampleAspectRatio() const noexcept override
   {
      if (mAVStream != nullptr)
   ...
   void SetSampleAspectRatio(
      SneedacityAVRational sample_aspect_ratio) noexcept override
   {
      if (mAVStream == nullptr)
         return;
