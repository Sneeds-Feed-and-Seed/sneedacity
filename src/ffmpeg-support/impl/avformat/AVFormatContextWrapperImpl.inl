...
static_assert(
   sizeof(SneedacityAVDictionaryEntry) == sizeof(AVDictionaryEntry) &&
   offsetof(SneedacityAVDictionaryEntry, key) == offsetof(AVDictionaryEntry, key)
      &&
   offsetof(SneedacityAVDictionaryEntry, value) == offsetof(AVDictionaryEntry,  value),
   "SneedacityAVDictionaryEntry does not safely overlay AVDictionaryEntry"
);
...
static_assert(
   ...
   && AV_NOPTS_VALUE == SNEEDACITY_AV_NOPTS_VALUE
   && AV_TIME_BASE == SNEEDACITY_AV_TIME_BASE
   && FF_QP2LAMBDA == SNEEDACITY_FF_QP2LAMBDA
   && FF_PROFILE_AAC_LOW == SNEEDACITY_FF_PROFILE_AAC_LOW
   && AVFMT_NOFILE == SNEEDACITY_AVFMT_NOFILE
   && AVFMT_GLOBALHEADER == SNEEDACITY_AVFMT_GLOBALHEADER
   && FF_COMPLIANCE_EXPERIMENTAL == SNEEDACITY_FF_COMPLIANCE_EXPERIMENTAL
   && AV_SAMPLE_FMT_U8 == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_U8)
   && AV_SAMPLE_FMT_U8P == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_U8P)
   && AV_SAMPLE_FMT_U8P == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_U8P)
   && AV_SAMPLE_FMT_S16P == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_S16P)
   && AV_SAMPLE_FMT_S32 == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_S32)
   && AV_SAMPLE_FMT_S32P == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_S32P)
   && AV_SAMPLE_FMT_FLT == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_FLT)
   && AV_SAMPLE_FMT_FLTP == static_cast<int>(SNEEDACITY_AV_SAMPLE_FMT_FLTP)
,
