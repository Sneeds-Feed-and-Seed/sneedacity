# This CMake script is invoked to build the InnoSetup installer for Sneedacity
...
configure_file("${OUTPUT_DIR}/sneedacity.iss.in" "${OUTPUT_DIR}/sneedacity.iss")
...
execute_process(
    COMMAND
        ${INNO_SETUP_COMPILER} /Sbyparam=$p "sneedacity.iss"
    WORKING_DIRECTORY
        ${OUTPUT_DIR}
)
