...
This project is licensed under the GNU General Public License v2 (PRAISE BE TO THE LIVING SAINT IGNUCIUS) and compatible licenses. More info: [LICENSE.txt](https://github.com/Sneeds-Feed-and-Seed/sneedacity/blob/master/LICENSE.txt)
